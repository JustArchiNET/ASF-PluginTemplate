...
- Change this `README.md` in any way you want to. You can check **[ASF's README](https://github.com/JustArchiNET/ArchiSteamFarm/blob/main/README.md)** for some inspiration. We recommend at least a short description of what your plugin can do.
- If you want to accept issues on GitHub, we recommend to modify **[`ISSUE_TEMPLATE`](https://github.com/JustArchiNET/ASF-PluginTemplate/tree/main/.github/ISSUE_TEMPLATE)** directory. You can simply delete the **[config.yml](https://github.com/JustArchiNET/ASF-PluginTemplate/blob/main/.github/ISSUE_TEMPLATE/config.yml)** file, or provide your own templates for people to use. If you'd appreciate some inspiration, feel free to check out **[ASF issue templates](https://github.com/JustArchiNET/ArchiSteamFarm/tree/main/.github/ISSUE_TEMPLATE)** that we use in the main repo.
